        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Our platform provides comprehensive tools to help you prepare for your next technical interview.
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description: 'Practice with hundreds of coding problems from real interviews at top tech companies.'
                },
                {
                  name: 'Multiple Choice Questions',
                  description: 'Test your knowledge with MCQs on various computer science fundamentals.'
                },
                {
                  name: 'Company-Specific Questions',
                  description: 'Get access to questions frequently asked by specific companies like Google, Amazon, and Facebook.'
                },
                {
      ...
      {/* <div className="bg-indigo-700">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg leading-6 text-indigo-200">
            Join thousands of developers who have improved their interview skills with PrepNow.
          </p>
          <Link
            to="/signup"
